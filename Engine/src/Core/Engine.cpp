...
namespace ECS {
    ...
    void Engine::Init()
    {
        ...
        _coordinator.RegisterComponent<Image>();
        ...
        _image = _coordinator.RegisterSystem<ImageSystem>();
        {
            Signature signature;
            signature.set(_coordinator.GetComponentType<Image>());
            _coordinator.SetSystemSignature<ImageSystem>(signature);
        }
    ...
    void Engine::Start()
    {
        ...
        if (_render) {
            ...
            _image->Start(_coordinator, _assetManager);
    ...
    void Engine::Render2D()
    {
        BeginDrawing();
            ...
            _image->Update(_coordinator, _assetManager);
        EndDrawing();
    }
